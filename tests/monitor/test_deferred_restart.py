...
from oellm_autoexp.monitor.actions import RestartAction, RestartActionConfig, ActionContext, EventRecord
...
def make_job(status):
    return JobRecord(job_id="j", definition=None, runtime=JobRuntime(submitted=True, runtime_job_id="123", last_status=status))
