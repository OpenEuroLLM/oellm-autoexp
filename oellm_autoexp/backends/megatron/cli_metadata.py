...
MEGATRON_ARG_METADATA: Mapping[str, MegatronArgMetadata] = {
    ...
    "async_tensor_model_parallel_allreduce": MegatronArgMetadata(
        arg_type=bool,
        default=True,
        help="NOTE: Deprecated. This flag is ignored.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
    ...
    "cuda_graph_impl": MegatronArgMetadata(
        arg_type=str,
        default="none",
        help='Determines the CUDA graph capture implementation. "none": no CUDA graph. "local": capture the CUDA graph using MCore local implementation. Either partial CUDA graph (1/many CUDA graph per layer) or full iteration CUDA graph (1 CUDA graph for whole iteration excluding optimizer) is enabled. "transformer_engine": capture the CUDA graph using TE make_graphed_callables().',
    ...
    "decrease_batch_size_if_needed": MegatronArgMetadata(
        arg_type=bool,
        default=False,
        help="If set, decrease batch size if microbatch_size * dp_size does not divide batch_size. Old batch_size will be restored if training is re-started with dp_size that divides batch_size // microbatch_size.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
    ...
    "deprecated_use_mcore_models": MegatronArgMetadata(
        arg_type=bool,
        default=False,
        help="DEPRECATED. Use the implementation from megatron core.Now ignored and mcore models are the default, use --use-legacy-models to not use core models.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
    ...
    "disable_chunked_prefill": MegatronArgMetadata(
        arg_type=bool, default=True, help="==SUPPRESS==", choices=None, nargs=0, element_type=None
    ),
    ...
    "distributed_timeout_seconds_after_init": MegatronArgMetadata(
        arg_type=int,
        default=None,
        help="Timeout seconds for process groups after initialization.This timeout is applied to all process groups after initialization.",
        choices=None,
        nargs=None,
        element_type=None,
    ),
    ...
    "enable_cuda_graph": MegatronArgMetadata(
        arg_type=bool,
        default=False,
        help="DEPRECATED and replaced by cuda_graph_impl. When set to true, either partial CUDA graph (1/many CUDA graph per layer) or full iteration CUDA graph (1 CUDA graph for whole iteration excluding optimizer) is enabled. --cuda-graph-scope determines the scope of graph capture.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
    ...
    "fp4_param": MegatronArgMetadata(
        arg_type=bool,
        default=False,
        help="If set, keep the parameters in fp4 precision to save memory. This option must be used together with fp4 mode (i.e., TransformerConfig.fp4 is not None). Note that not all parameters will be converted to fp4; for example, biases will remain unchanged.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
    ...
    "inference_dynamic_batching_num_cuda_graphs": MegatronArgMetadata(
        arg_type=int,
        default=16,
        help="Maximum number of cuda graphs to capture, where the cuda graph batch sizes range from 1 to `max_requests`. (See `dynamic_context.py` for details on how `max_requests` is computed). Due to rounding, the actual number of cuda graphs may not equal this argument.",
        choices=None,
        nargs=None,
        element_type=None,
    ),
    ...
    "langrl_external_server": MegatronArgMetadata(
        arg_type=None, default=False, help=None, choices=None, nargs=0, element_type=None
    ),
    ...
    "moe_extended_tp": MegatronArgMetadata(
        arg_type=bool,
        default=False,
        help="NOTE: Deprecated from MCore v0.10. This flag is ignored. Its functionality is replaced by expert_tensor_parallel_size.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
    ...
    "moe_hybridep_num_sms": MegatronArgMetadata(
        arg_type=int,
        default=16,
        help="Number of SMs to use for HybridEP. In pure NVL scenarios, 16 SMs can generally achieve good bandwidth.",
        choices=None,
        nargs=None,
        element_type=None,
    ),
    ...
    "moe_pad_experts_for_cuda_graph_inference": MegatronArgMetadata(
        arg_type=bool,
        default=False,
        help="some MoE routers have a D2H sync that will break cuda graphs.  If this flag is set the router will switch to dropping and padding during decode time which does not have a D2H sync. The capacity factor is set to the max that an expert could see during inference so no tokens are actually dropped.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
    ...
    "moe_router_score_function": MegatronArgMetadata(
        arg_type=str,
        default="softmax",
        help='Score function for MoE routing. Can be "softmax" or "sigmoid".',
    ...
    "phase_transition_iterations": MegatronArgMetadata(
        arg_type=str,
        default=None,
        help="Comma-separated list of iterations where phase transitions occur. Requires fixed global batch size across phases. Does not support batch size ramp-up.",
        choices=None,
        nargs=None,
        element_type=None,
    ),
    ...
    "rl_offload_inference_model_weights_when_idle": MegatronArgMetadata(
        arg_type=None,
        default=False,
        help="When using a separate RL inference model with UVM-enabled parameters, prefetch its weights to CPU when not doing rollout inference, and prefetch back to GPU right before inference. Requires --rl-inference-model-unified-memory-level=1.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
    ...
    "sharp_enabled_group": MegatronArgMetadata(
        arg_type=str,
        default=None,
        help="IB SHARP can be enabled from only one communication group. By default, it is enabled from dp group. Available options: [dp, dp_replica]",
    ...
    "tiktoken_special_tokens": MegatronArgMetadata(
        arg_type=list,
        default=None,
        help='List of tiktoken special tokens, needs to have ["<unk>", "<s>", "</s>", "<mask>", "<pad>", "<cls>", "<sep>"]',
        choices=None,
        nargs="+",
        element_type=str,
    ),
    ...
    "use_torch_fsdp2": MegatronArgMetadata(
        arg_type=bool,
        default=False,
        help="Use the torch FSDP2 implementation. FSDP2 has not been tested with pipeline parallelism, and may contain bugs.",
        choices=None,
        nargs=0,
        element_type=None,
    ),
...
MEGATRON_ACTION_SPECS: Mapping[str, MegatronActionSpec] = {
    ...
    "async_tensor_model_parallel_allreduce": MegatronActionSpec(
        option_strings=(
            ...
            "--disable-async-tensor-model-parallel-allreduce",
        ),
        action_type="store_false",
        nargs=0,
        const=False,
    ...
    "ckpt_fully_parallel_save": MegatronActionSpec(
        option_strings=("--no-ckpt-fully-parallel-save", "--disable-ckpt-fully-parallel-save"),
        action_type="store_false",
        nargs=0,
        const=False,
        default=True,
