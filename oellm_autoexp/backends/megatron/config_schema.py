...
class MegatronConfig(ConfigInterface):
    ...
    # Number of SMs to use for HybridEP. None uses the default from DeepEP. In pure NVL
    # scenarios, 16 SMs can generally achieve good bandwidth.
    ...
    # Tokens exceeding this budget will be dropped. None means no token will be dropped. The
    # default is None.
    ...
    position_embedding_type: Literal['learned_absolute', 'rope', 'yarn', 'mrope', 'relative', 'none'] = 'learned_absolute'
    ...
    # generation-batches to control the degree of staleness.
